@echo --------------------------------------------------
@echo Command Selector
@echo --------------------------------------------------
@echo Action          : Usage
@echo --------------------------------------------------
@echo login           : It can log in Google or others account on Google Account.
@echo server          : It can construct your servers simultaneously by running VBS file, and connect your browser as "localhost" by using with Node.js, PHP, Python and Ruby.
...
@echo Release date    : 2023,May,7th
@echo Version         : 1.1
