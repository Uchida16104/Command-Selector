...
echo "programming     : It can run javascript, python, ruby, php, haskell, and lua code. (And if you want to add the languages you want to program in, you will need to set them up in your custom in the shell script file.)"
